...
export const METRIC_CATALOG = [
  { id: "users.unique", group: "Users", label: "Unique users", definition: "Distinct identity-resolved people with qualifying activity.", matches: ["each", "any", "all"], breakdowns: commonBreakdowns, drilldown: ["users"] },
