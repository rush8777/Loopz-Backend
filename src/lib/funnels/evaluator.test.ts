...
import { summarizeFunnel, type FunnelProgressionRow } from "./evaluator.js";
...
const row = (...timestamps: Array<number | null>): FunnelProgressionRow => ({ identity: "user", stepTimestamps: timestamps });
