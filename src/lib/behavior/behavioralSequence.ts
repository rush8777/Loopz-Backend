...
import type { Episode } from "./episodeSegmentation.js";
...
export function behavioralSequenceForEpisode(episode: Episode): string[] {
...
export function behavioralSequenceForEvents(events: readonly BehavioralEvent[]): string[] {
