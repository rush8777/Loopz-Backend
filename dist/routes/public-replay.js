 ...
 */
export function registerPublicReplayRoutes(app, db) {
    app.post("/public/sites/:siteId/replay", async (request, reply) => {
        ...
        if (!MVP1_STORAGE_POLICY.sessionReplay)
        ...
        await db.insert(sessionReplayEvents).values(events.map((e, i) => ({
            siteId: site.id,
            sessionId,
            seq: seqOffset + i,
            rrwebType: e.type,
...
//# sourceMappingURL=public-replay.js.map