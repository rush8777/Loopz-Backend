...
function groupSchema(depth) {
    const nodeSchema = depth >= MAX_GROUP_DEPTH ? conditionSchema : z.union([conditionSchema, z.lazy(() => groupSchema(depth + 1))]);
    return z.object({
        logic: z.enum(["and", "or"]),
...
export const segmentDefinitionSchema = groupSchema(0);
