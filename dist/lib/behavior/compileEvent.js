...
import { createClickEvent, createHoverIntentEvent, createPageEnterEvent, createScrollEvent, createCustomEvent, } from "./behavioralEvent.js";
/**
 ...
 */
export function compileToBehavioralEvent(event) {
    if (isRawTelemetryEvent(event))
        return null;
    switch (event.type) {
        case "page_view":
...
//# sourceMappingURL=compileEvent.js.map