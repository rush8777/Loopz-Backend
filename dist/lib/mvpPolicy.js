...
export function shouldPersistSessionEvent(type) {
    if (type === "cursor")
        return MVP1_STORAGE_POLICY.cursorEvents;
    if (type === "hover")
        return MVP1_STORAGE_POLICY.hoverEvents;
    return true;
}
//# sourceMappingURL=mvpPolicy.js.map