...
function matchesRule(pagePath, rule) {
...
export function filterMatchingPaths(pagePaths, rules) {
    return pagePaths.filter((path) => matchesRules(path, rules));
}
//# sourceMappingURL=pageMatcher.js.map